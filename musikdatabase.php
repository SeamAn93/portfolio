...
<section class="bg-black">
    <div class="container py-5">
        ...
        <p class="text-white fs-6 pb-5">
            En øvelse i at kode med php, opsætte en database med phpMyAdmin, lave en API og til sidst, fetch fra en API, samt at opsætte en side med et fedt design, som er responsiv.
            <br><br>
            Det endte med en musik database, hvor brugeren kan finde detaljer om en sang, et album, en kunstner og meget mere.
        </p>
        <h2 class="text-white mb-3">UI-designer, front-end og back-end developer</h2>
        <p class="text-white fs-6 pb-4">
            I forløbet var jeg med til at lave prototyper for designet af siderne, kode front- og back-end delen af siderne, hvor backend delen bestod af php, javascript og opsætningen af databasen i phpMyAdmin.
        </p>
...
<section>
    <div class="container py-5">
        ...
        <p class="fs-6 pb-4">
            ...
            <br><br>
            Insert form, som gjorde det muligt at tilføje nye numre / data til databasen, ved at oprette en database i phpMyAdmin, med forskellige parameter, som var relevant viden for et musiknumre. Derefter kunne inputs fletterne og SQL bruges til at indsætte det data, brugeren har indtastet.
            <br><br>
            Til vores to tekstfelter, “Band members” og “Tracklist”, bruges der TinyMCE. Dog er det ikke den bedste løsning, fordi hvis brugeren fx kopier en trackliste over i input feltet, kommer det hele i et paragraph tag i html'en, som skabe en anden styling end hvad der er tiltænkt. Løsningen her ville være at lave individuelle input felter for hvert numre på albummet, og derefter compile det til et dataset.
            <br><br>
            ...
            Vil man redigere, kommer den sammen form op, som på insert siden, bare hvor de allerede indtastede informationer står, og som man så kan redigere i.
            Normalt ville de ikke være tilgængelig for brugeren, men er i dette tilfælde synlige for at vise hele projektet.
        </p>
