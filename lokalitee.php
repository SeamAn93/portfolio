...
<head>
    <meta charset="utf-8">
    <title>Projekter - LOKALITEE</title>
    ...
    <div class="container py-5">
        <div class="flex-column d-flex flex-md-row justify-content-md-between gap-1 mb-4">
            <div class="d-inline-block mx-auto mb-4">
                <a href="img/tryktiltshirt.png" target="_blank">
                    <img class="project__img__size" src="img/tryktiltshirt.png" alt="design af våbenskjoldet for Sakskøbing">
                </a>
            </div>
            <div class="d-inline-block mx-auto mb-4">
                <a href="img/muckupslokalitee.png" target="_blank">
                    <img class="project__img__size" src="img/muckupslokalitee.png" alt="mockups af websitet">
                </a>
            </div>
        </div>
